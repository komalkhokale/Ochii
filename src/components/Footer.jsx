...
function Footer() {
  ...
  // ✅ Scroll setup (Footer ke liye)
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: ["start end", "end start"],
  });

  // ✅ Footer neeche se upar jayega
  ...
  return (
    <motion.div
      ref={ref}
      style={{ y: pageY }}
      className="w-full h-screen flex gap-5 bg-zinc-900 p-20 -mt-[10vw] font-['Neue_Montreal'] overflow-hidden"
    >
      {/* LEFT SECTION */}
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-1">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-1">
            Opening
      ...
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="top">
          ...
          <div className="dets mt-10">
            ...
            <a className="block text-xl font-light mt-1" href="">
              Instagram
            </a>
            <a className="block text-xl font-light mt-1" href="">
              Twitter
